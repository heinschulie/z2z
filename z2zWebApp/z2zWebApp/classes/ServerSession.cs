...
namespace Z2Z
{
    public class ServerSession
    {
        ...
        //#region Logon PublicUser
        ///// <summary>
        ///// Logon to Ruci via a call to PublicServiceConsumer, save the connected PublicPublicUser and PublicPublicUserToken to HttpSessionState.
        ///// </summary>
        ///// <param name="aHttpSessionState">An HttpSessionState from the calling page.</param>
        ///// <param name="aPublicPublicUser">A public user.</param>
        //public static void Logon(HttpSessionState aHttpSessionState, PublicUser aPublicUser)
        //{
        //    //
        //    // Populate a PublicToken
        //    //
        //    PublicToken vPublicToken = GetPublicToken(aHttpSessionState);
        //    vPublicToken.PublicID = aPublicUser.PubPublicID;
        //    vPublicToken.Password = aPublicUser.PubPassword;
        //    vPublicToken.Url = "http://localhost/z2zsoap/Z2ZService.asmx";
        //    //vPublicToken.Url = "http://www.zephry.co.za/zclientsoap/lookforservice.asmx";
        //    vPublicToken.Context = ConnectionContext.Browse;
        //    vPublicToken.Version = "web";
        ...
        public static void Logon(HttpSessionState aHttpSessionState, User aUser)
        {
            ...
            { 
                ...
                Url = "http://localhost/z2zsoap/Z2ZService.asmx" 
            };
            //
            // Get a User by ID
            //
        ...
        public static void ClearSessionBusiness(HttpSessionState aHttpSessionState)
        {
            ...
            {
                if ((aHttpSessionState.Keys[i] != sessionUser) &&
