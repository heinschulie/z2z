...
namespace Z2Z
{
    ...
    /// </summary>
    public class UserFunctionAccessCollection : UserKey
    {
        #region Static Constructor

        /// <summary>
        /// Initializes the <see cref="UserFunctionAccessCollection"/> class.
        /// </summary>
        /// <remarks>
        /// Constructor overload is static for instant construction (not lazy)
        /// </remarks>
        static UserFunctionAccessCollection()
        {
        }
        ...
        ///   Instance.
        /// </summary>
        private static UserFunctionAccessCollection _instance = new UserFunctionAccessCollection();

        /// <summary>
        /// Gets the <see cref="UserFunctionAccessCollection"/> instance.
        /// </summary>
        /// <value>
        /// The instance.
        /// </value>
        public static UserFunctionAccessCollection Instance
        {
